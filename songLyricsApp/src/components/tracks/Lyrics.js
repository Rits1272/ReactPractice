  ...
  render(){
    ...
    if (track === undefined || lyrics === undefined || Object.keys(track).length === 0 || Object.keys(lyrics).length === 0){
      ...
      return(
        <React.Fragment>
        <Link to = '/'>
            <button className='btn btn-primary btn-sm mb-4'>Go Back</button>
          </Link>
          <div className='card'>
          ...
          <ul className='list-group mt-3'>
              ...
              <li className='list-group-item'><strong>Release Date : </strong><Moment format="DD/MM/YY">{track.updated_time}</Moment></li>
